...
export default class extends PureComponent {
  ...
  render () {
    ...
    let timestamp = (new Date()).valueOf() + 7*24*3600*1000
      ...
      <div styleName={classNames('infoContainer', {show: innerShow, hide: !innerShow})} onClick={e => e.stopPropagation()}>
        <div styleName='skuContainer'>
          ...
          <div styleName='skuInfo'>
            ...
            <div styleName='info'>{presellInfo.presell_status === 2 ? `预计发货时间:${formatTime(presellInfo.presell_send_time, 'MM月DD日')}` : `预计发货时间:${formatTime(timestamp, 'MM月DD日')}`}</div>
