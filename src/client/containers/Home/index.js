  ...
  render () {
    ...
    return <div styleName='wrap'>
      ...
      <div styleName='plat subject'>
        <Slider data={collocation} needDesc setting={{infinite: false, slidesToShow: 1.1, dots: false, autoplay: false, afterChange: (e) => this.setState({currentCollocation: e})}} slideStyle={{paddingRight: '0.1rem'}} />
      </div>
      <div styleName='label'>
